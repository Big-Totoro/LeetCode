...
public class _496_Test {
    ...
    private static _496.Solution3 solution3;

    @BeforeClass
    public static void setup() {
        solution1 = new _496.Solution1();
        solution2 = new _496.Solution2();
        solution3 = new _496.Solution3();
    }
    ...
    public void test11() {
        ...
        assertThat(solution3.nextGreaterElement(new int[] {4, 1, 2}, new int[] {1, 3, 4, 2})).isEqualTo(new int[] {-1, 3, -1});
    }
    ...
    public void test12() {
        ...
        assertThat(solution3.nextGreaterElement(new int[] {2, 4}, new int[] {1, 2, 3, 4})).isEqualTo(new int[] {3, -1});
    }
}